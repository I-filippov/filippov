...
namespace Filippov.Controllers
{
    public class AspNetUserRolesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.UserId = new SelectList(db.AspNetUsers, "Id", "FIO");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,RoleId,Email")] AspNetUserRoles aspNetUserRoles)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,RoleId,Email")] AspNetUserRoles aspNetUserRoles)
        {
            if (ModelState.IsValid)
            {
